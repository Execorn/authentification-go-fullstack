...
import (
	"backend-app/backend/core/config"
	"backend-app/tools/text"
	"bytes"
	"fmt"
	"log"
	"mime/multipart"
...
// Service holds a backend-app config.Config and provides functions to send emails
type Service struct {
	Config config.Config
}

// New takes a backend-app config.Config and returns an instance of Service
